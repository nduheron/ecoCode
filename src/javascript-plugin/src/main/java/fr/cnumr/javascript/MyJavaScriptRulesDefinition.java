 ...
 */
public class MyJavaScriptRulesDefinition implements RulesDefinition {

    // don't change that because the path is hard coded in CheckVerifier
    private static final String RESOURCE_BASE_PATH = "fr/cnumr/l10n/javascript/rules/eslint/";

    public static final String LINTER_NAME = "ESLint";

    private static final String ESLINT_PLUGIN = "ecocode-rules";
